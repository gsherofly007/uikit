...
class CardDataConfig {
          ...
          navigatorPage: (BuildContext context) {
            Navigator.push(context, MaterialPageRoute(
              builder: (BuildContext context) {
                return const InputTextPage("ActionSheet示例");
              },
            ));
          }));
       return GroupInfo(groupName: "文本组件", children: children, isExpand: true);
  }
  static GroupInfo _getButton(){
    ...
    children.add(GroupInfo(
        ...
        navigatorPage: (BuildContext context) {
          Navigator.push(context, MaterialPageRoute(
            builder: (BuildContext context) {
              return  ButtonPage("自定义按钮");
            },
          ));
        }));
    return GroupInfo(groupName: "按钮组件", children: children, isExpand: true);
  }
  ...
  static GroupInfo _alert(){
    ...
    return GroupInfo(groupName: "弹框组件", children: children, isExpand: true);
  }
  //
  // /// 数据图表
